...
DEFAULT_HEADERS = {
    ...
    # DİKKAT: Accept-Encoding'i ELLE AYARLAMA. requests yalnızca açabildiği
    # yöntemleri ister (gzip, deflate). Buraya "br" eklenirse site brotli
    # gönderir, requests açamaz ve elimize çözülmemiş ikili veri geçer —
    # sayfa sağlam iner ama hiçbir seçici tutmaz.
